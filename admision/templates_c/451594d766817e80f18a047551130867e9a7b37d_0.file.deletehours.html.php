<?php
/* Smarty version 3.1.30, created on 2017-08-25 16:55:34
  from "C:\xampp\htdocs\citas_medicas\admision\templates\deletehours.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59a03a664766a1_05644069',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '451594d766817e80f18a047551130867e9a7b37d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\citas_medicas\\admision\\templates\\deletehours.html',
      1 => 1503067983,
      2 => 'file',
    ),
  ),
...
function content_59a03a664766a1_05644069 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!--                                 <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Eliminar horarios de la reservación de quirófano</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <form role="form" method="post" autocomplete="off" action="deleteh.php">
                            <?php echo $_smarty_tpl->tpl_vars['alerta']->value;?>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <label for="" class="control-label">Eliminar horarios disponibles:</label>
                                    <button type="submit" class="btn btn-danger" name="verificar">Eliminar</button>
                                </div>
                            </form>
                            </div>
                            <!-- /.row (nested) -->
