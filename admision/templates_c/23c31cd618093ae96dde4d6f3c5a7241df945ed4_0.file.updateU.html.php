<?php
/* Smarty version 3.1.30, created on 2017-08-18 16:23:14
  from "C:\xampp\htdocs\citas_medicas\admision\templates\updateU.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5996f8527c81a0_24003626',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '23c31cd618093ae96dde4d6f3c5a7241df945ed4' => 
    array (
      0 => 'C:\\xampp\\htdocs\\citas_medicas\\admision\\templates\\updateU.html',
      1 => 1502745224,
      2 => 'file',
    ),
  ),
...
function content_5996f8527c81a0_24003626 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
                                ...
                                <tbody>
                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['usuarios']->value, 'usuario', false, NULL, 'usuarios', array (
));
if ($_from !== null) {
...
?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $_smarty_tpl->tpl_vars['usuario']->value['rif'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['usuario']->value['usuario'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['usuario']->value['cedula'];?>
</td>
                                        <td><center><a id="positivo" class="btn btn-warning btn-sm"  href="update.php?id=<?php echo $_smarty_tpl->tpl_vars['usuario']->value['id'];?>
&rif=<?php echo $_smarty_tpl->tpl_vars['usuario']->value['rif'];?>
&cedula=<?php echo $_smarty_tpl->tpl_vars['usuario']->value['cedula'];?>
&usuario=<?php echo $_smarty_tpl->tpl_vars['usuario']->value['usuario'];?>
&privilegio=<?php echo $_smarty_tpl->tpl_vars['usuario']->value['is_admin'];?>
"><i class="fa fa-cog"></i> Modificar</a> <a href="deleteU.php?id=<?php echo $_smarty_tpl->tpl_vars['usuario']->value['id'];?>
" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-remove"></i> Eliminar</a></center></td>
                                    </tr> 
                                  <?php
}
}
