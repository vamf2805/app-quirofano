<?php
/* Smarty version 3.1.30, created on 2017-08-25 16:43:53
  from "C:\xampp\htdocs\citas_medicas\admision\templates\registerU.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59a037a9d76dd4_02869768',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '415d2d9b3d6c81f30086aa2fad2c721d1ba4e264' => 
    array (
      0 => 'C:\\xampp\\htdocs\\citas_medicas\\admision\\templates\\registerU.html',
      1 => 1502746977,
      2 => 'file',
    ),
  ),
...
function content_59a037a9d76dd4_02869768 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <form role="form" method="post" autocomplete="off" action="register.php">
                            <?php echo $_smarty_tpl->tpl_vars['alerta']->value;?>

                                <div class="col-lg-6">
                                    <div class="form-group">
                                         <label for="" class="control-label">Ingresar rif a registrar:</label>
                                        <input type="text" class="form-control" name="rif" placeholder="12345">
                                    </div>
                                    <div class="form-group">
                                        <label>Prioridad de usuario</label>
                                        <select class="form-control" name="privilegio">
                                            <option value="<?php echo $_smarty_tpl->tpl_vars['privilegios']->value[0];?>
"><?php echo $_smarty_tpl->tpl_vars['privilegios']->value[3][0];?>
</option>
                                            <option value="<?php echo $_smarty_tpl->tpl_vars['privilegios']->value[1];?>
"><?php echo $_smarty_tpl->tpl_vars['privilegios']->value[3][1];?>
</option>
                                            <option value="<?php echo $_smarty_tpl->tpl_vars['privilegios']->value[2];?>
"><?php echo $_smarty_tpl->tpl_vars['privilegios']->value[3][2];?>
</option>
                                        </select>
                                    </div>
                                 <label for="" class="control-label">Registrar usuario:</label>
                                 <button type="submit" class="btn btn-primary" name="verificar">Registrar</button>
                                </div>
                            </form>
                            </div>
                            <!-- /.row (nested) -->
