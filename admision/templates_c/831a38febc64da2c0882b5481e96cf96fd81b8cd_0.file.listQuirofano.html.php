<?php
/* Smarty version 3.1.30, created on 2017-08-14 23:46:47
  from "C:\xampp\htdocs\citas_medicas\admision\templates\listQuirofano.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59921a4772f407_24207126',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '831a38febc64da2c0882b5481e96cf96fd81b8cd' => 
    array (
      0 => 'C:\\xampp\\htdocs\\citas_medicas\\admision\\templates\\listQuirofano.html',
      1 => 1502746987,
      2 => 'file',
    ),
  ),
...
function content_59921a4772f407_24207126 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!--                                 <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Lista de horarios de las reservaciones de los quirófanos</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <form role="form" method="get" autocomplete="off" action="searchQ.php">
...
<!--                                     <div class="checkbox">
                                        <label>
                                            <input type="checkbox" id="select_q" name="check" value="1"  onchange="javascript:showContent()">¿Desea seleccionar un quirófano?
                                        </label>
                                    </div> -->
                                    <div class="form-group" id="select_quirofano">
                                    ...
                                    <label for="" class="control-label">Verificar lista de horarios horarios:</label>
...
>
    function showContent() {
        element = document.getElementById("select_quirofano");
        check = document.getElementById("select_q");
        if (check.checked) {
