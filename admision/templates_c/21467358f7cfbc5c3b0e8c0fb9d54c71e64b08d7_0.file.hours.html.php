<?php
/* Smarty version 3.1.30, created on 2017-08-14 23:46:44
  from "C:\xampp\htdocs\citas_medicas\admision\templates\hours.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59921a443523e8_77441842',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '21467358f7cfbc5c3b0e8c0fb9d54c71e64b08d7' => 
    array (
      0 => 'C:\\xampp\\htdocs\\citas_medicas\\admision\\templates\\hours.html',
      1 => 1502747034,
      2 => 'file',
    ),
  ),
...
function content_59921a443523e8_77441842 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!--                                 <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Listas de las reservaciones de los quirófanos</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <form role="form" method="get" autocomplete="off" action="table.php">
                            <?php echo $_smarty_tpl->tpl_vars['alerta']->value;?>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="fechaF" id="datepickerF" placeholder="yyyy-mm-dd">
                                    </div>
                                    <label for="" class="control-label">Verificar solicitudes:</label>
...
>
        $( function() {
         ...
         $( function() {
            $( "#datepickerF" ).datepicker({  minDate: 0, maxDate: "+1M",dateFormat: 'yy-mm-dd' });
        } );
    <?php echo '</script'; ?>
>
</body>
