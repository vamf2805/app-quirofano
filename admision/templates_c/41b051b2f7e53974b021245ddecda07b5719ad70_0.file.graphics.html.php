<?php
/* Smarty version 3.1.30, created on 2017-08-14 23:46:57
  from "C:\xampp\htdocs\citas_medicas\admision\templates\graphics.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59921a5102c820_31054459',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '41b051b2f7e53974b021245ddecda07b5719ad70' => 
    array (
      0 => 'C:\\xampp\\htdocs\\citas_medicas\\admision\\templates\\graphics.html',
      1 => 1502747056,
      2 => 'file',
    ),
  ),
...
function content_59921a5102c820_31054459 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!--                                 <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Estadisticas de los quirófanos</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <form role="form" method="get" autocomplete="off" action="graphicsQ.php">
                            <?php echo $_smarty_tpl->tpl_vars['alerta']->value;?>

                                <div class="col-lg-6">
                                    <div class="form-group">
                                         <label for="" class="control-label">Seleccionar una fecha inicial:</label>
                                        <input type="text" class="form-control" name="fechaI" id="datepicker" placeholder="yyyy-mm-dd">
                                    </div>
                                    <div class="form-group">
                                         <label for="" class="control-label">Seleccionar una fecha final:</label>
                                        <input type="text" class="form-control" name="fechaF" id="date" placeholder="yyyy-mm-dd">
                                    </div>

                                    <label for="" class="control-label">Generar gráficas:</label>
                                    <button type="submit" class="btn btn-primary" name="verificar">Chequear</button>
                                </div>
                            </form>
                            </div>
                            <!-- /.row (nested) -->
